...
#reads event data for all leagues
all_event_data <- read_rds("prem_event_data_15-16.rds")
matches <- read_rds("prem_matches_15-16.rds")
match_event_data <- all_event_data
